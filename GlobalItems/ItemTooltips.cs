    ...
    public class ItemTooltips : GlobalItem
    {
        public override void ModifyTooltips(Item item, List<TooltipLine> tooltips)
        {
            foreach (TooltipLine tooltipLine in tooltips)
            {
                ...
                tooltipLine.Text = tooltipLine.Text.Replace("The Sky Squires are a unit of southern Ithon, protecting the kingdoms of Yln, Klycub, and Norapass.", "天空侍卫是南以桑的一支队伍，职责是保护伊林(Yln）、Klycub和Norapass等王国。");
                ...
                {
                    tooltipLine.Text = tooltipLine.Text.Replace("'A sallet helm made of Kanite, worn by the Sky Squires of Ithon. The metal has a blue hue and a cold touch,", "“一种用Kanite制成的轻盔，为以桑的天空侍卫们所装备。");
                ...
                {
                    tooltipLine.Text = tooltipLine.Text.Replace("'A tabard made of Kanite and cloth in a checkered pattern, worn by the Sky Squires of Ithon. The metal", "“一种用Kanite和丝绸制成的带方格图案的无袖外罩，为以桑的天空侍卫们所装备。");
                ...
                {
                    tooltipLine.Text = tooltipLine.Text.Replace("'Greaves made of Kanite, worn by the Sky Squires of Ithon. The metal has a blue hue and a cold touch,", "“一种用Kanite制成的护胫，为以桑的天空侍卫们所装备。");
                    tooltipLine.Text = tooltipLine.Text.Replace("being used as a replacement for iron which is lacking in southern Ithon.", "这种金属具有蓝色的色调和冰冷的触感，在缺乏铁矿资源的南以桑作为铁的替代品。");
                }
                // 沉没船长画
